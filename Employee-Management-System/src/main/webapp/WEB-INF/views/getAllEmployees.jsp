...
<body>
		...
		<table class="tg">
			...
			<c:forEach items="${employees}" var="emp">
				<tr>			
					...
					<td>${emp.address}</td>
					<td>${emp.salary}</td>
					<td><a href="<c:url value='/updateCustomer/${emp.id}' />">Edit</a></td>
					<td><a href="<c:url value='/deleteCustomer/${emp.id}' />">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
    ...
    <div id="home">
        <h5>
            <a id="ancher" href="http://localhost:8080/Employee-Management-System"> Return to Home Page</a>
        </h5>
    </div>
